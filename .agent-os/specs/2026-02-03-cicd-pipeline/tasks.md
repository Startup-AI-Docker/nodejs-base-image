...
- [x] 2. Implement Dockerfile linting job
  ...
  - [ ] 2.3 Test lint job catches Dockerfile issues
...
- [x] 3. Implement Docker build job
  ...
  - [ ] 3.4 Verify build completes and artifact is uploaded
...
- [x] 4. Implement security scanning job
  ...
  - [ ] 4.5 Test scan blocks on vulnerabilities
...
- [x] 5. Implement push to registry job
  ...
  - [ ] 5.5 Verify image published to GHCR with correct tags
...
- [ ] 7. End-to-end validation
  - [ ] 7.1 Test PR workflow (lint + build + scan, no push)
  - [ ] 7.2 Test push to main (full pipeline + latest tag)
  - [ ] 7.3 Test tag release (full pipeline + semver tags)
  - [ ] 7.4 Verify image pulls correctly from GHCR
